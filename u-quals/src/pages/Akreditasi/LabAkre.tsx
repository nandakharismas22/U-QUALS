...
import BasicTableOne from "../../components/Akreditasi/lab/AkreLab"
...
export default function TabelsAkreLab() {
const { isOpen, openModal, closeModal } = useModal();
  ...
  return (
    <>
      <PageMeta
        title="U-Quals - Akreditasi Lab"
        description=""
      />
      <PageBreadcrumb pageTitle="Akreditasi Lab" />
