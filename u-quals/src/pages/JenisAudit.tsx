...
import AuditTable from "../components/audit/SemuaJenisAudit";
...
export default function TablesAudit() {
  ...
  return (
    <>
      <PageMeta
        title="U-Quals - Jenis Audit"
        description=""
      />
      <PageBreadcrumb pageTitle="Jenis Audit" />
      <div className="space-y-6">
      <ComponentCard
          title={
            <div className="flex items-center justify-between w-full">
              <span className="text-base font-medium text-gray-800 dark:text-white/90">
                Semua Jenis Audit: {tableData.length}
              </span>
              <button
