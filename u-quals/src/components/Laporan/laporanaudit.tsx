...
export default function LaporanAuditTable() {
          ...
          <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
            {tableData.map((periode, index) => (
              <TableRow key={periode.id_periode}>
                ...
                <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                  <div className="flex items-center gap-2">
                    <span className={`px-3 py-1 font-medium rounded-full ${getStatusBadgeStyle(periode.status)}`}>
                        {periode.status}
                    </span>
                  </div>
                </TableCell>
               <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                  <div className="flex items-center gap-2">
                    {/* Ikon FileText */}
                    <div 
                      className="p-2 rounded-full bg-blue-100 hover:bg-blue-200 dark:bg-blue-700 dark:hover:bg-blue-600 cursor-pointer"
